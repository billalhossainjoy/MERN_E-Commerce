...
import { getAdminOrders } from "@/store/features/shopping/order.slice";
      ...
      <div className="container m-auto p-5">
        ...
        <div className="p-6 border rounded-lg">
              ...
              {orderLists.map((order) => (
                <TableRow>
                  ...
                  <TableCell>
                    <span
                      className={cn(
                        "rounded-full py-1 px-3 text-white flex xl:w-1/2 justify-center w-full font-bold",
                        {
          ...
          <Dialog open={orderView} onOpenChange={setOrderView}>
            <AdminOrderDetails setOrderView={setOrderView} />
          </Dialog>
        </div>
      </div>
    </div>
